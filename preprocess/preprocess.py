...
from configs.config_ml_model import BATCH_SIZE
...
def preprocess():
    ...
    train_data_augmentation = ImageDataGenerator(rescale=1 / 255.0,
                                                 rotation_range=20,
                                                 zoom_range=0.05,
    ...
    val_data_augmentation = ImageDataGenerator(rescale=1 / 255.0)
    ...
    test_gen = val_data_augmentation.flow_from_directory(
        test_path,
        class_mode="categorical",
        target_size=(96, 96),
        color_mode="rgb",
    ...
    val_gen = val_data_augmentation.flow_from_directory(
        validation_path,
        class_mode="categorical",
        target_size=(96, 96),
        color_mode="rgb",
    ...
    data_preprocess = {"train_Gen": train_gen,
                       "test_Gen": test_gen,
